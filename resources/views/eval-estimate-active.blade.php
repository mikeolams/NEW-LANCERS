...
@section('title', 'Evaluation Estimate Active Nav-Bar')
...
<div class="">
  <input class="text-center cnc" value="SET UP THIS PROJECT" type="button">
</div>
...
<div class="section1">
  ...
  <div id="bill">
    ...
    <div class="hours">
      ...
      <i class="fa fa-calendar start"><input type="text" onfocus="(this.type='date')" name="estStartDate"
          placeholder=" Set start date" /></i>
      <i class="fa fa-calendar end"><input type="text" onfocus="(this.type='date')" name="estEndDate"
  ...
  <div>
    ...
    <div class="hour">
      ...
      <input type="text" name="est2" id="est2" placeholder="E.g. Illustrator, Consulting..." class="sub"/>
    </div><br />
  ...
  <button class="btn">SET UP THIS PROJECT</button>
</div>
