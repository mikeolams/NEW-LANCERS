                ...
                <section class="mainContentBelowLogo">
                    <section>
                        ...
                        <div class="addressAndPayment row">
                            ...
                            <div class="card payment ml-auto">
                                ...
                                <div class="Amount" style="font-size: 2em; font-weight: bold">US$8,800.00 <span
                                        style="font-size: 0.5em">USD</span></div>

                                <div>
                                    <div class="issueDate float-left">
                                        <div style="font-size: 0.8em; color: #B1B1B1">Issued <p
                                                style="font-size: 1.2em; color: black">02/10/2019</p>
                                        </div>
                                    </div>
                                ...
                                <button type="button" class="btn btn-primary paymentButton">Pay with
                                    Flutterwave</button>
                            </div>
                        </div>
                    ...
                    <section class="invoiceDetails row">
                        <div class=" table-card" style="margin-top: 10px">
                            <div class="">
                                Invoice <span style="font-weight: bold; font-size: 0.6em; color: #B1B1B1">No. 1</span>
                                <p class="serviceRendered" style="margin-top: 10px">Glacier Fintech App</p>
                            </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr scope="row">
                                            ...
                                            <td style="font-weight:normal">US$8,800.00<br>US$8,800.00<br>US$8,800.00
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
