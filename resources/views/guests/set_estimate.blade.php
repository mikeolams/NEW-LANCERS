    ...
    <div id="bill">
      ...
      <div>
        ...
        <div class="date">
          ...
          <i class="fa fa-calendar"></i><input type="text" onfocus="(this.type='date')" name="start" placeholder=" Set start date" />
          <i class="fa fa-calendar"></i><input type="text" onfocus="(this.type='date')" name="end" placeholder="Set end date" />
        </div>
    </div>
