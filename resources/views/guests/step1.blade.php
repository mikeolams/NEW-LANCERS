...
@section('header')
 <div id="container">
    <div>
        <button class="close navM"  id="close"><img id="clear" src="https://res.cloudinary.com/celx/image/upload/v1570718446/vhmdnd4sf3f5w3burj4m.svg" alt=""></button>
    </div>
    <div>
        <p class="nav cEstimate" id="cre">Create Estimate</p>
    </div>
    <div>
       <input class="navM disabled" id="ext" type="button" value="NEXT">
    </div>
  </div>
@endsection
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="dropdown mr-1">
                   <select class="dropbtn"  id="projectSelect"  disabled>
    ...
    function verifyPath(){
        ...
        if ( createProject !== "" && createProject !== null ){
            ...
            document.querySelector('.next').classList.remove('disabled');
             ...
             document.querySelector('#ext').style.background = 'rgba(207, 204, 204, 0.4)';
